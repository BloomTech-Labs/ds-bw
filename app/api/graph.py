...
# original data
# df = pd.read_csv('https://raw.githubusercontent.com/VegaSera/spotify_song_suggester/master/SpotifyAudioFeaturesApril2019.csv.csv')

# Alternative reduced sampled song data
df = pd.read_csv(
    'https://raw.githubusercontent.com/VegaSera/spotify_song_suggester/master/SpotifyAudioFeatures_samples_20000.csv')

df2 = df.drop(columns=['artist_name', 'track_id',
                       'track_name', 'duration_ms', 'time_signature'])
